                    ...
                    <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <select name="category_id" class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 font-medium focus:outline-none focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 transition-all appearance-none cursor-pointer">
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="return_template_id" class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 font-medium focus:outline-none focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 transition-all appearance-none cursor-pointer">
                                    ...
                                    @foreach($returnTemplates as $tmpl)
                                        <option value="{{ $tmpl->id }}" {{ old('return_template_id', $product->return_template_id) == $tmpl->id ? 'selected' : '' }}>
                                            {{ $tmpl->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="url" name="video_url" value="{{ old('video_url', $product->video_url) }}" placeholder="https://www.youtube.com/watch?v=..." class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 font-medium focus:outline-none focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 transition-all">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 gap-2">
                                <div class="flex items-center justify-between p-4 bg-amber-50 text-amber-700 rounded-2xl border border-amber-100">
                                    ...
                                    <input type="checkbox" name="is_popular" value="1" {{ $product->is_popular ? 'checked' : '' }} class="h-5 w-5 rounded-md border-amber-300 text-amber-600 focus:ring-amber-500 cursor-pointer">
                                </div>
                                <div class="flex items-center justify-between p-4 bg-blue-50 text-blue-700 rounded-2xl border border-blue-100">
                                    ...
                                    <input type="checkbox" name="free_shipping" value="1" {{ $product->free_shipping ? 'checked' : '' }} class="h-5 w-5 rounded-md border-blue-300 text-blue-600 focus:ring-blue-500 cursor-pointer">
                                </div>
                                <div class="flex items-center justify-between p-4 bg-green-50 text-green-700 rounded-2xl border border-green-100">
                                    ...
                                    <input type="checkbox" name="eft_discount" value="1" {{ $product->eft_discount ? 'checked' : '' }} class="h-5 w-5 rounded-md border-green-300 text-green-600 focus:ring-green-500 cursor-pointer">
                                </div>
                            </div>
                        </div>
                    </div>
