...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center mb-8">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-black italic tracking-tighter text-slate-900 uppercase underline decoration-[var(--primary-color)] decoration-4 underline-offset-8">Yeni Marka</h1>
            <p class="mt-4 text-sm text-gray-500 font-medium">Sisteme yeni bir marka eklemek için formu eksiksiz doldurunuz.</p>
        </div>
    ...
    <div class="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            <form action="{{ route('admin.brands.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8 bg-white/50 backdrop-blur-xl p-8 rounded-[40px] border border-white shadow-2xl shadow-slate-200/50 overflow-hidden relative group">
                @csrf
                ...
                <div class="relative space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <div class="flex items-center gap-6">
                                ...
                                <div @click="document.getElementById('logo').click()" 
                                    ...
                                    <i class="fas fa-cloud-upload-alt text-3xl text-slate-300 mb-2 group-hover/upload:text-[var(--primary-color)] transition-colors animate-bounce"></i>
                                    <span class="text-xs font-black italic uppercase tracking-tighter text-slate-400 group-hover/upload:text-[var(--primary-color)] transition-colors">Tıklayarak Logo Seçin</span>
                    ...
                    <div class="pt-6 border-t border-slate-100 flex gap-4">
                        <button type="submit" class="flex-grow px-10 py-5 bg-[var(--primary-color)] text-white font-black italic uppercase tracking-tighter rounded-2xl shadow-2xl shadow-orange-100 hover:bg-[var(--primary-hover)] transition-all transform hover:scale-105 active:scale-95 flex items-center justify-center gap-3">
                            <i class="fas fa-save"></i> Markayı Kaydet
                        </button>
            ...
            <div class="space-y-6">
                <div class="bg-slate-900 p-8 rounded-[40px] text-white shadow-2xl relative overflow-hidden group">
                    <div class="absolute right-0 top-0 w-32 h-32 bg-white/5 rounded-full -mr-16 -mt-16 group-hover:scale-110 transition-transform"></div>
                     <i class="fas fa-info-circle text-orange-400 text-2xl mb-4"></i>
                     <h3 class="text-lg font-black italic tracking-tighter uppercase mb-2">Profesyonel Yönetim</h3>
                     <p class="text-xs text-slate-400 font-bold leading-loose">Buraya eklediğiniz markalar ürün düzenleme sayfasında seçim olarak gözükecektir. Marka logoları ise site ön yüzünde profesyonel bir görünüm sağlar.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-[40px] shadow-xl shadow-slate-200/50 border border-slate-50">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <p class="text-[11px] text-slate-600 font-medium">Logoların şeffaf arka planlı (PNG) olması önerilir.</p>
                        </li>
                        <li class="flex items-start gap-3">
                            <div class="h-6 w-6 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0 mt-1">
                                <i class="fas fa-check text-[10px]"></i>
                            </div>
                            <p class="text-[11px] text-slate-600 font-medium">Minumum 200x200px çözünürlük idealdir.</p>
                        </li>
                        <li class="flex items-start gap-3">
                            <div class="h-6 w-6 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0 mt-1">
                                <i class="fas fa-check text-[10px]"></i>
                            </div>
                            <p class="text-[11px] text-slate-600 font-medium">Marka adını tam ve doğru yazdığınızdan emin olun.</p>
                        </li>
                    </ul>
                </div>
            </div>
