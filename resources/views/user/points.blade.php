...
<div class="user-content-card">
    <div class="flex items-center gap-4 border-b border-gray-100 pb-6 mb-6">
        <div class="w-14 h-14 bg-brand-50 text-brand-600 rounded-2xl flex items-center justify-center text-2xl shadow-inner shadow-brand-100/50">
    ...
    <!-- Puan Bakiyesi -->
    <div class="bg-gradient-to-r from-brand-500 to-brand-600 rounded-3xl p-8 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-lg shadow-brand-500/30 mb-10 relative overflow-hidden">
        ...
        <div class="relative z-10 flex items-center gap-6">
            ...
            <div>
                <p class="text-brand-100 font-bold uppercase tracking-widest text-sm mb-1">Mevcut Bakiyeniz</p>
                <div class="flex items-baseline gap-2">
                    <span class="text-5xl font-black tracking-tighter drop-shadow-sm">{{ $user->med_puan }}</span>
                    <span class="text-xl font-bold text-brand-100">Puan</span>
                </div>
            </div>
        </div>
        <div class="relative z-10 bg-white text-brand-700 px-6 py-4 rounded-2xl shadow-xl flex items-center gap-4 min-w-[200px]">
            <div class="w-10 h-10 bg-brand-50 rounded-xl flex items-center justify-center text-brand-500">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
            <div>
                <h3 class="text-lg font-bold text-slate-800 flex items-center gap-2 mb-3">
                    <i class="fas fa-question-circle text-brand-500"></i> Med Puan Nedir?
                </h3>
            ...
            <div>
                <h3 class="text-lg font-bold text-slate-800 flex items-center gap-2 mb-3">
                    <i class="fas fa-shopping-bag text-brand-500"></i> Nasıl Kullanırım?
                </h3>
                <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                    <ul class="space-y-3 text-sm text-slate-600">
                        ...
                        <li class="flex items-start gap-2">
                            <i class="fas fa-check text-green-500 mt-1"></i>
                            <span>Girdiğiniz puan değeri anında genel toplamdan düşülecektir. Puanlarınızın karşılığı: <strong class="text-brand-600">1 Puan = {{ number_format($rate, 2, ',', '.') }} TL</strong></span>
                        </li>
                    </ul>
                </div>
            </div>
            
            <a href="{{ route('home') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-brand-50 text-brand-600 border border-brand-100 rounded-xl text-sm font-bold hover:bg-brand-100 transition-colors">
        ...
        <div>
            <h3 class="text-lg font-bold text-slate-800 flex items-center gap-2 mb-3">
                <i class="fas fa-gift text-brand-500"></i> Puan Kazanım Tablosu
            </h3>
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-5 py-4 text-right">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 bg-brand-50 text-brand-600 rounded-lg text-sm font-black border border-brand-100">
                                    +{{ $rule->points }} Puan
                                </span>
                            </td>
                        </tr>
